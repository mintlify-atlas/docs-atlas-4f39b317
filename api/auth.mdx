...
<ResponseField name="usuario" type="object">
  ...
  <Expandable title="usuario fields">
    ...
    <ResponseField name="rol" type="string">Assigned role: `Master` or `Promotor`.</ResponseField>
  </Expandable>
</ResponseField>
...
Returns a list of all registered users ordered by creation date descending. Intended for **Master** users to monitor and manage accounts.
...
<ResponseField name="correo" type="string">Email address.</ResponseField>
<ResponseField name="rol" type="string">Role: `Master`, `Promotor`, or `Repartidor`.</ResponseField>
<ResponseField name="activo" type="number">Account status as a TINYINT: `1` = active, `0` = disabled.</ResponseField>
