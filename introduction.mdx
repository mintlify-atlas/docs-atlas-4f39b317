---
title: "Yakult App: Sales Management Platform for Distributors"
sidebarTitle: "Introduction"
description: "Yakult App is a mobile-first sales platform for Yakult distributors — React Native + Expo mobile app paired with an Express 5 / MySQL backend."
---
...
**Mobile App (React Native + Expo):** Built with React Native 0.74.5 and Expo ~51.0.28 using the file-based `expo-router`, the mobile client is the primary interface for all three user roles. It communicates with the backend exclusively over a local network REST API, storing session tokens in `AsyncStorage` for persistent authentication.
